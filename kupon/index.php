...
<head>
    ...
    <title>Tambah Kupon Bajar KFC PTS</title>

    <link rel="shortcut icon" type="image/x-icon" href="../favicon.ico">
    <script src="https://cdn.tailwindcss.com"></script>
</head>

<body class="bg-gradient-to-br from-teal-50 via-white to-teal-100 min-h-screen flex items-center justify-center">

    <div class="w-full max-w-lg bg-white rounded-2xl shadow-xl p-8 border border-teal-100">
        <h1 class="flex items-center justify-center gap-3 text-3xl font-extrabold text-teal-700 mb-8">
            <img src="logo.png" alt="Logo" class="w-12 h-12 rounded-full shadow-md border border-teal-200" />
            <span class="tracking-wide">Kupon Bajar KFC PTS</span>
        </h1>


        <!-- Notifikasi sukses & error -->
        <?php if (!empty($success)): ?>
            <div class="mb-6 flex items-center gap-2 bg-teal-100 border border-teal-300 text-teal-800 px-4 py-3 rounded-lg shadow-sm">
        ...
        <form method="POST" class="space-y-5">
            ...
            <div>
                ...
                <textarea id="nomor_kupon" name="nomor_kupon" rows="3"
                    class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none resize-none"
            ...
            <div class="pt-4">
                <button type="submit"
                    class="w-full bg-teal-600 text-white font-semibold py-2.5 rounded-lg hover:bg-teal-700 transition-all duration-200 shadow-md">
